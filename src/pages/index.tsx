  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your team with HR Management System - Streamline employee data, manage vacations, track time, organize payrolls, and conduct performance evaluations, all in one central place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your team with HR Management System - Streamline employee data, manage vacations, track time, organize payrolls, and conduct performance evaluations, all in one central place.`}
            </Text>
            <Box
